...
-Save the user settings in an xml file in the "Sumo Projects\MyProgram\ExperimentConFile" folder
...
"Sumo Projects\MyProgram\ExperimentConFile"
-In the command prompt, go to the "Sumo Projects\MyProgram" folder and then run the "ProgramLauncher.py" in python
...
"MyProgram" - This folder contains all of the code needed to run simulations in SUMO. Within this folder
