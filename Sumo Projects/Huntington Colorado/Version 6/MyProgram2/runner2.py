...
def run():
    ...
    while traci.simulation.getMinExpectedNumber() > 0:
        ...
        #if len(listOfVehicles) == 3:
           # if(newPlat):
                #newList = [listOfVehicles[0], listOfVehicles[1],listOfVehicles[2]]
...
if __name__ == "__main__":
    ...
    sumoProcess = subprocess.Popen([sumoBinary, "-c", myP + "\\huntingtonColorado.sumo.cfg", "--tripinfo-output",
